...
module.exports = function(timeInterval){
    ...
    var bdqueries = function(selectedApp, selectedCountry){
        ...
        this.popularPartsQuery = {
            ...
            'end-date': endDate,
            'metrics': 'ga:totalEvents',
            'filters': selectedCountry ? 'ga:eventCategory==Part;ga:eventAction==add;ga:country=='+selectedCountry+';ga:appID=='+selectedApp :  'ga:eventCategory==Part;ga:eventAction==add;ga:appID=='+selectedApp,
            'dimensions': 'ga:eventLabel',
            'sort': '-ga:totalEvents',
            'max-results': 5,
        }
